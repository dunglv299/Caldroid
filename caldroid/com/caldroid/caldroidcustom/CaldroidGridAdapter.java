...
public class CaldroidGridAdapter extends BaseAdapter {
	...
	protected void customizeTextView(int position, TextView cellView) {
		...
		if (shouldResetDiabledView && shouldResetSelectedView) {
			// Customize for today
			if (dateTime.equals(getToday())) {
				cellView.setTextColor(resources.getColor(R.color.caldroid_cyan));
				cellView.setBackgroundResource(R.drawable.today_bg);
			} else {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// For reuse
		if (convertView == null) {
			cellView = (TextView) inflater
					.inflate(R.layout.lib_date_cell, null);
		}
