...
import com.caldroid.infiniteviewpager.InfinitePagerAdapter;
import com.caldroid.infiniteviewpager.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
	...
	protected void refreshMonthTitleTextView() {
		...
		String monthTitle = DateUtils
				.formatDateRange(getActivity(), monthYearFormatter, millis,
						millis, MONTH_YEAR_FLAG).toString().toUpperCase();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		leftArrowButton = (ImageButton) view
